...
dir_base='E:/AI'
wr_file=dir_base+'/temp_feactures/fect_train_lastset.txt'   
...
for i in filenames:
    i_array=i.split('.')
    wr_file=dir_base+'/temp_feactures/'+i+'_feactures.txt'  
    
    i=dir_read_train+i
    file_wr_auth=open(wr_file,"w")
    print('file: '+i +' reading started......')
    read_file (i)
    file_wr_auth.close()
    print('file: '+i +' reading ended......')
